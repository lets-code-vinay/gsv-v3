...
import { GSV_LOCATIONS } from "../../configs/OurPresence/gsvLocations";
    ...
    return (
      <>
        ...
        <div className={classes["buttonContainer"]}>
          ...
          <Typography className={classes["county-name"]} id="select-india">
            India
          </Typography>
          <Typography className={classes["county-name"]} id="select-europe">
            Europe
          </Typography>
        </div>
      </>
